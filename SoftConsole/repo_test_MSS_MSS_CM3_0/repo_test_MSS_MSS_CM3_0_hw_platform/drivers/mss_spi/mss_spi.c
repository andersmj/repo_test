 ...
 *
 * SVN $Revision: 6232 $
 * SVN $Date: 2014-03-15 08:02:53 -0700 (Sat, 15 Mar 2014) $
 */
#include "mss_spi.h"
...
)
{
    ...
    {
        /*
         * The SPS flag ensures the slave select remains asserted even if we
         * don't keep the TX FIFO filled in block mode. This will not work
         * on A2F200 parts and a GPIO driving the slave select directly would
         * be required or operation via DMA with these devices.
         *
